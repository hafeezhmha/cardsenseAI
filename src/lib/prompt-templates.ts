...
Question: {question}
Answer (If Rule 9 applies, provide ONLY the social reply. Otherwise, if Rule 10 applies, ensure no redundant greeting. Otherwise, if Rule 2 & 4 lead to "NO_DATA", use that. Otherwise, provide the confident, context-based answer, adhering to all rules):
`;
